 ...
 */
package robo.gerenciamento.old;
 ...
 * @author stefan
 */
public class WebcamManagerNew implements WebcamListener, WebcamDiscoveryListener {
...
//    HeadlessMediaPlayer mediaPlayer;
    ...
    public WebcamManagerNew(Dimension resolution) {
...
//            configWebcam();
        ...
        Webcam.addDiscoveryListener(WebcamManagerNew.this);
    }
...
//        System.out.println("config");
        ...
        webcam.addWebcamListener(WebcamManagerNew.this);
//        if (sampling_enabled) webcam.open();
    }

    public final synchronized void startStream() {
        if (webcam_available) {
            webcamStreamer = new WebcamStreamerNew(host_port, webcam, fps, true);
