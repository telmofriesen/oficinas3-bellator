...
public class ServerListener extends Thread {
    ...
    private ArrayList<ServerConnection> connectionsArray = new ArrayList<ServerConnection>();
...
//                System.out.println("[TR_ServerListener] Antes do accept: " + acceptedSocket);
                ...
                final ServerConnection connection = new ServerConnection(this, acceptedSocket);
...
//        connection.disconnect();
    ...
    public synchronized ServerConnection getServerConnection(int index) {
