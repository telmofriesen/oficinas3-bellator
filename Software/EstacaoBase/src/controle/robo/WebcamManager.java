...
//        webcamStreamer = new WebcamStreamerNew(stream_port, webcam, sample_rate, true);
        if (webcam_available) {
            ...
            String mrl = String.format("v4l2://%s", device);
            String options = formatRtpStream(resolution, bitrate, fps, host_ip, host_port);
...
//            webcamStreamer.stop();
    ...
    private static String formatRtpStream(Dimension resolution, int bitrate, float fps, String host_ip, int host_port) {
