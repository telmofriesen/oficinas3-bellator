...
public class SensorIR {
    //A posicao do sensor no robo (em relacao ao centro)
     ...
     * @param posicaoRobo A posicao XY do sensor IR no robo, *** em relacao ao centro de movimento dele **  
     ...
     * @param min_detec Distância mínima de detecção do sensor (cm). 
     * @param max_detec Distância máxima de detecção do sensor (cm).
     */
