...
A Figura \ref{fig:diagrama_classes} mostra o diagrama de classes da estação base.
\begin{figure}[H]
  \centering
...
\begin{table}[h]
  ...
  \begin{tabular}{p{6cm}p{8cm}}
    ...
    \textbf{Classe} & \textbf{Descrição} \\ 
    \midrule
    ClientMessageProcessor & Responsável pela interpretação dos comandos recebidos pelo cliente. \\ \hline
    ClientConnector & Responsável por efetuar a gerência da conexão do cliente (estação base) com o servidor (robô). \\ \hline
...
A Figura \ref{fig:diagrama_classes_sist_embarcado} mostra o diagrama de classes do sistema embarcado.
\begin{figure}[H]
  \centering
...
\subsection{Descrição das classes do software para o sistema embarcado (TS-7260)}
...
\begin{table}[h]
  ...
  \begin{tabular}{p{6cm}p{8cm}}
   ...
   ServerMessageProcessor & Responsável pela interpretação dos mensagens recebidas pelo servidor (robô). \\ \hline
   ServerListener & Responsável por escutar as novas conexões de clientes. \\ \hline
   ServerSender & Responsável por enviar mensagens ao host de uma conexão. \\ \hline
   ServerReceiver & Responsável por receber mensagens de um host de uma conexão. \\ \hline
