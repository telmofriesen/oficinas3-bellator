...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth, keepaspectratio]{./figuras/estacaoBase/usecase_estacao_base.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth, keepaspectratio]{./figuras/sistEmbarcado/usecase_linux_embarcado.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth, keepaspectratio]{./figuras/sistEmbarcado/usecase_placa_baixo_nivel.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{./figuras/estacaoBase/class_estacaoBase.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{./figuras/sistEmbarcado/class_sistEmbarcado.png}
