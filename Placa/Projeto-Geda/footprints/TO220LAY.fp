	...
	Element(0x00 "-5V 1.5A voltage regulator" "" "uA7905C-laying" 50 570 1 100 0x00)
(
...
# The mounting hole is 139 to 160 mils diameter
	Pin(100 800 90 60 "Com" 0x101)
	Pin(200 800 90 60 "In" 0x01)
	Pin(300 800 90 60 "Out" 0x01)

	# Befestigungsbohrung
	Pin(200 130 150 130 "In" 0x01)
